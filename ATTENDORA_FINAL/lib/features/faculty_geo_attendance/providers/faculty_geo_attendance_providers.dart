...
final facultyGeoAttendanceServiceProvider = Provider<FacultyGeoAttendanceService>(
  (ref) => FacultyGeoAttendanceService(),
);

final geoAttendanceSettingsProvider = StreamProvider.family<GeoAttendanceSettings?, String>(
